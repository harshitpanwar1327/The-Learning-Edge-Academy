    ...
    <>
      <section className="mt-15 bg-linear-to-br from-[#0d1d50] via-[#203072] to-[#4A56A6] py-20 text-white md:py-28">
        <div className="mx-auto max-w-3xl px-6 xl:px-0">
          ...
          <h1 className="mt-5 text-4xl font-bold leading-tight tracking-[-2px] md:text-6xl">Let's Talk About Your Goals</h1>
          <p className="mt-6 text-lg leading-8 text-white/80">Book a free demo, request a counselor callback or simply visit our Gurgaon campus — we'd love to meet you.</p>
        </div>
      </section>
